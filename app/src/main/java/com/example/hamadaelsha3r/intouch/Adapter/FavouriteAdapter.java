...
public class FavouriteAdapter extends RecyclerView.Adapter<com.example.hamadaelsha3r.intouch.Adapter.MainAdapter.NewsHolder> {
    ...
    public FavouriteAdapter(Context context, List<Model> movieList) {
    ...
    @Override
    public com.example.hamadaelsha3r.intouch.Adapter.MainAdapter.NewsHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.row_news, parent, false);
        return new com.example.hamadaelsha3r.intouch.Adapter.MainAdapter.NewsHolder(view);
    }

    @Override
    public void onBindViewHolder(final com.example.hamadaelsha3r.intouch.Adapter.MainAdapter.NewsHolder holder, final int position) {
